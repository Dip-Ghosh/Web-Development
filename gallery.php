...
<div class="container-fluid">
  <div class="wallpaper-menu">
    <ul>
      <li >Photos</li>
      <li data-filter=".inside">Chicken Biriyani</li>
      <li data-filter=".outside">Kacchi Biriyani</li>
     
    </ul>
  </div>

<div class="wallpaper-item w1">
    <div class="item inside g3">
    ...
    <div class="item outside g3">
     ...
     <div class="item outside g3">
      <img src="images/7.jpg" class="img-fluid" alt="Responsive image">
    </div>

    <div class="item outside g3">
      <img src="images/8.jpg" class="img-fluid" alt="Responsive image">
    </div>
